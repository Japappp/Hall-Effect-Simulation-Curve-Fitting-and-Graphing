...
def format_func(value, tick_number):
    return f'{value:.12f}'
###path_CS = Specify the path to the file that is being read
...
scaling_factor_CS = df_CS[df_CS['Theta'] ==
                          0.1].loc[df_CS[df_CS['Theta'] == 0.1]['pow_load'].idxmax(), 'alpha']
...
Alphas_for_few_fits = [ df_CS['alpha'][372], df_CS['alpha'][420], df_CS['alpha'][720], df_CS['alpha'][997], df_CS['alpha'][1359] ]

Alphas_scaled_for_few_fits = [ df_CS['alpha_scaled'][6], df_CS['alpha_scaled'][420], df_CS['alpha_scaled'][720], df_CS['alpha_scaled'][997], df_CS['alpha_scaled'][1359] ]
...
plt.title(f'Corbino Sector Simulation Results for Anomalous Hall effect \n Plat/P0 vs \u03B1 at given \u03F4, average r2 = {avg_r2} \n With Offset \n FIT= a*x**2/(1+x**2) + c', fontsize=30)
